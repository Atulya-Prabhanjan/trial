...
function Footer(){
    return(<div className="Footer" style={{top:"180px"}}>
        <div className="Foo-Element">
            <Link to={Home} style={{ textDecoration: 'none', color: 'grey' }}><img src={logo}  className="animate-spin-logo" style={{display: "inline-block",position: "absolute",top:"0px",left:"3px",height: "80px",width: "80px"}} alt=" "/></Link>
